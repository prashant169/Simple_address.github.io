...
public class MultiInputPane extends JOptionPane {
   ...
   *                        parameter can be
   *                        null, in which case no initial values are specified;
   *                        or individual
   *                        elements can be null, indicating that no initial value
   *                        is specified for
   *                        a particular field
   ...
   *                      in which case no initial values are specified; or
   *                      individual elements can
   *                      be null, indicating that no initial value is specified
   *                      for a particular
   *                      field
   */
