...
public class FileSystem {
  ...
  public AddressBook readFile(File bookFile)
    ...
    ObjectInputStream localObjectInputStream = new ObjectInputStream(new FileInputStream(bookFile));
  ...
  public void saveFile(AddressBook book, File bookFile)
    ...
    ObjectOutputStream localObjectOutputStream = new ObjectOutputStream(new FileOutputStream(bookFile));
