...
public class AddressBookController {
  ...
  public void doAdd(AddrookGUI gui) {
    ...
    String[] person = { "ID", "First Name", "Last Name", "Address", "City", "State", "ZIP", "Phone", "Email" };

    String[] personData = MultiInputPane.showMultiInputDialog(gui, person, "Add Person Information");
  ...
  public void doEdit(AddrookGUI gui, int id) {
    ...
    String[] personInfo = gui.getAddressBook().getOtherPersonInformation(id);
    String[] editInfo = { "Address", "City", "State", "ZIP", "Phone", "Email" };
    String[] personData = MultiInputPane
  ...
  public void doOfferSaveChanges(AddrookGUI gui)
    ...
    int i = JOptionPane.showConfirmDialog(gui, "There are unsaved changes. Save them?",
        "Save changes", 1);
